...
# них. Тип здесь ничего не решает — файл уходит вложением, — но пусть будет
# честным: браузер показывает его в списке загрузок.
...
def оригинал(параметры):
    ...
    цель = os.path.join(склад, f"{ид}{'' if с_датой else '_nd'}_{os.path.basename(имя)}")
