...
const (
	...
	// Пятнадцать, а не пять: модуль имеет право сделать работу перед ответом.
	// Лента модерации, например, доделывает миниатюры своей страницы — свежие
	// кадры иначе не показать вовсе, их загружают быстрее, чем успевает любое
	// расписание. Ответ без картинок приходит быстро и не стоит ничего.
